...
public class ListViewHolders {
    ...
    public static abstract class BaseViewHolder extends RecyclerView.ViewHolder {
        ...
        abstract void bind(SpreadsAdapter.ListItem item);
    }
    ...
    public static class LabelViewHolder extends BaseViewHolder {
        ...
        public LabelViewHolder(View itemView, Resources resources) {
            super(itemView, resources);
        }

        @Override
        void bind(SpreadsAdapter.ListItem item) {
    ...
    public static class FilterViewHolder extends BaseViewHolder {
        ...
        public void bind(SpreadsAdapter.ListItem item) {
